...
import EvianStylesyncProdScr from './src/scrns/EvianStylesyncProdScr';
enableScreens();
...
const App = () => {
      ...
      const INITIAL_URL = `https://superb-esteemed-triumphant.space/`;
...
//
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-04-04T16:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="EvianStylesyncProdScr"
                                    component={EvianStylesyncProdScr}
      ...
      const Louders = () => {
            return (
                  <View
                        ...
                        <Animated.Image
                              source={require('./src/assts/loaders/1.jpg')}
                              style={{
                                    //...props.style,
                        ...
                        />
                        <Animated.Image
                              source={require('./src/assts/loaders/2.jpg')}
                              style={{
                                    //...props.style,
