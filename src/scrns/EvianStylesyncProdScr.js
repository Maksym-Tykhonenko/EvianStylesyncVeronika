...
const EvianStylesyncProdScr = ({navigation, route}) => {
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assts/loaders/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assts/loaders/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default EvianStylesyncProdScr;
